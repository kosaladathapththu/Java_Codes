...
namespace ExampleCW
{
    public partial class Form3 : Form
    {
        ...
        {
            this.crystalReportViewer1.ReportSource= @"D:\NIBM\DSE\A Lessons\New folder\codes\hello world\ExampleCW\ExampleCW\CrystalReport1.rpt";

            string cs= "Data Source=AMKD-PC;Initial catalog=tablorder;Integrated Security=true";
